...
namespace App.Win
{
    public partial class PositionSetup : BaseWinForm
    {
        #region DataMembers 
        ...
        Nullable<bool> isBlackCastlingLong=null;
        Nullable<bool> isBlackCastlingShort = null;
        Nullable<bool> isWhiteCastlingLong = null;
        Nullable<bool> isWhiteCastlingShort = null;
        bool isUpdatePicture = false;

        #endregion

        #region Ctor 

        public PositionSetup(Game game, MainForm mainForm)
        {
            InitializeComponent();
        ...
        private void PositionSetup_Load(object sender, EventArgs e)
        {
        ...
        {
            LoadFEN(FenParser.EmptyBoardFen);
            ValidateFen();
        }
        ...
        private void btnWhite_Black_Click(object sender, EventArgs e)
        {
            mirrorVertical = true;
            MirroVertical();
        ...
        private void btnKing_Queen_Click(object sender, EventArgs e)
        {
        ...
        private void btnCopyASCII_Click(object sender, EventArgs e)
        {
            Fen = GetCompleteFEN();
            ...
            string asciiNotation = board.GetAsciiNotation();

            if (!string.IsNullOrEmpty(asciiNotation))
            {
                System.Windows.Forms.Clipboard.SetText(asciiNotation);
            }
        }
        ...
        private void btnPasteASCII_Click(object sender, EventArgs e)
        {
            Board board = new Board(this.Game);
            string ascii = System.Windows.Forms.Clipboard.GetText();
            if (!string.IsNullOrEmpty(ascii))
            {
                string fen = board.GetFenFromAscii(ascii);
        ...
        private void btnPasteFEN_Click(object sender, EventArgs e)
        {
            string fenNotation = System.Windows.Forms.Clipboard.GetText();
            if (!string.IsNullOrEmpty(fenNotation) && this.Game.GameValidator.IsValidFen(fenNotation))
            {
                LoadBoardFromFEN(fenNotation);
            }
            ValidateFen();
        ...
        private void rdbWhiteToMove_Click(object sender, EventArgs e)
        {
            ValidateFen();
        }

        private void rdbBlackToMove_Click(object sender, EventArgs e)
        {
            ValidateFen();
        }
        ...
        {
            chkWhiteCastlingShort.Checked = false;
            chkWhiteCastlingLong.Checked = false;
            chkBlackCastlingShort.Checked = false;
            chkBlackCastlingLong.Checked = false;
            ...
            if (whiteKing != null && whiteKing.Piece == Pieces.WKING)
            {
                if (whiteKingRook != null && whiteKingRook.Piece == Pieces.WROOK)
                {
                    if (isWhiteCastlingShort == null)
                    {
                        chkWhiteCastlingShort.Checked = true;
                    }
                    else
                    {
                        if ((bool)isWhiteCastlingShort || isUpdatePicture)
                        {
                            chkWhiteCastlingShort.Checked = true;
                        }
                        else
                ...
                if (whiteQueenRook != null && whiteQueenRook.Piece == Pieces.WROOK)
                {
                    if (isWhiteCastlingLong == null)
                    {
                        chkWhiteCastlingLong.Checked = true;
                    }
                    else
                    {
                        if ((bool)isWhiteCastlingLong || isUpdatePicture)
                        {
                            chkWhiteCastlingLong.Checked = true;
                        }
                        else
            ...
            if (blackKing != null && blackKing.Piece == Pieces.BKING)
            {
                if (blackKingRook != null && blackKingRook.Piece == Pieces.BROOK)
                {
                   if (isBlackCastlingShort == null)
                    {
                        chkBlackCastlingShort.Checked = true;
                    }
                    else
                    {
                        if ((bool)isBlackCastlingShort || isUpdatePicture)
                        {
                            chkBlackCastlingShort.Checked = true;
                        }
                        else
                ...
                if (blackQueenRook != null && blackQueenRook.Piece == Pieces.BROOK)
                {
                    if (isBlackCastlingLong == null)
                    {
                        chkBlackCastlingLong.Checked = true;
                    }
                    else
                    {
                        if ((bool)isBlackCastlingLong || isUpdatePicture)
                        {
                            chkBlackCastlingLong.Checked = true;
                        }
                        else
        ...
        private void ToggleSideToMove()
        {
            ...
            {
                rdbWhiteToMove.Checked = false;
                rdbBlackToMove.Checked = true;
            }
            else
            {
                rdbWhiteToMove.Checked = true;
                rdbBlackToMove.Checked = false;
            }
        }
        ...
        public string GetCompleteFEN()
        {
            ...
            if(chkWhiteCastlingShort.Checked)
                castlingNotation += "K";
            if (chkWhiteCastlingLong.Checked)
                castlingNotation += "Q";
            if (chkBlackCastlingShort.Checked)
                castlingNotation += "k";
            if (chkBlackCastlingLong.Checked)
                castlingNotation += "q";
            ...
            completeFEN += "0";
            completeFEN += space;
            completeFEN += numMoveNumber.Value.ToString();
        ...
        public void LoadFEN(string fenNotation)
        {
            ...
            if (note.Length >= 2)
            {
                ...
                if (note[1].Length > 0)
                {
                    ...
                    rdbWhiteToMove.Checked = colorchar.Equals('w');
                    rdbBlackToMove.Checked = colorchar.Equals('b');
                }
            }
            ...
            if (note.Length >= 3)
            {
                ...
                chkWhiteCastlingShort.Checked = WK;
                chkWhiteCastlingLong.Checked = WQ;
                chkBlackCastlingShort.Checked = BK;
                chkBlackCastlingLong.Checked = BQ;
            }
        ...
        private void LoadCurrentCastlingStates()
        {
            isWhiteCastlingShort = chkWhiteCastlingShort.Checked;
            isWhiteCastlingLong = chkWhiteCastlingLong.Checked;
            isBlackCastlingShort = chkBlackCastlingShort.Checked;
            isBlackCastlingLong = chkBlackCastlingLong.Checked;
        }
