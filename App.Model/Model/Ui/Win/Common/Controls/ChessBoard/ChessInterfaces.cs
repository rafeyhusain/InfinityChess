...
namespace ChessLibrary
{
  ...
  public interface IValidation
  {
    ...
    /// <returns></returns>
    Move move(Pieces piece, string fromSquare, string toSquare,Move m);
  ...
  public interface IValidationEvents
  {
    ...
    void KingIsInCheck(bool isColor);
    void KingIsFree();
    void FinishedMove();
    void UpdateBoard(Chess.Operation op, string FromSquare, string ToSquare,Move m);
