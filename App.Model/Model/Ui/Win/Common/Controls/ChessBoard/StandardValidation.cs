...
namespace ChessLibrary
{
    ...
    public class StandardValidation : IPositionEvents, IValidation
    {
        ...
        public event CapturedPieceFromStandingWindow EventCapturedPieceFromStandingWindow;
        ...
        /// </summary>
        public StandardValidation(Game game)
        {
            this.Game = game;
        ...
        /// <returns></returns>
        Bitboard getLegalMoves(Pieces piece, ChessPosition Attacker, ChessPosition Attacked)
        {
            ...
            switch (piece)
            {
                ...
                case Pieces.BQUEEN:
                    ...
                    {
                        this.Game.InProgressMove.Flags.IsAmbigousMove = true;
                        ...
                        for (int i = 0; i < Rowlist.Count; i++)
                        {
                            ...
                            {
                                this.Game.InProgressMove.Flags.IsAmbigousMoveRow = true;
                            }
                        }
                        for (int j = 0; j < Collist.Count; j++)
                        {
                            ...
                            {
                                this.Game.InProgressMove.Flags.IsAmbigousMoveColumn = true;
                            }
                        }
                        if (!this.Game.InProgressMove.Flags.IsAmbigousMoveRow && !this.Game.InProgressMove.Flags.IsAmbigousMoveColumn)
                        {
                            this.Game.InProgressMove.Flags.IsAmbigousMoveRow = true;
                        }
                    }
        ...
        */
        ...
        public void promotePawn(Pieces piece, string square)
        {
            ...
            if (canPromote)
            {
                if (EventPromotion != null)
                {
                    ...
                    this.Game.InProgressMove.Flags.IsPromotion = true;

                    promotePiece = App.Win.frmSelectPiecePromotion.GetPromotedPiece(this.Game, color);
            ...
            if (!Attacker.isKingMated & !Attacked.isKingMated)
            {
                ...
                if ((Attacker.Board & coFromSquare.getSquareMask()) != (Bitboard)0)
                {
                    ...
                    if ((Attacker.Board & coToSquare.getSquareMask()) == (Bitboard)0)
                    {
                        ...
                        if (legalMoves == 1449033180106457088)
                        {
                        ...
                        if ((legalMoves & coToSquare.getSquareMask()) != (Bitboard)0)
                        {
                            if ((Attacked.Board & coToSquare.getSquareMask()) != (Bitboard)0)
                            {
                                if ((Attacked.Queens & coToSquare.getSquareMask()) != (Bitboard)0)
                                {
                                    ...
                                    this.Game.InProgressMove.Flags.IsCapture = true;
                                }
                            ...
                            else if (Enpasant == coToSquare.getSquareMask())
                            {
                                ...
                                {
                                    this.Game.InProgressMove.CapturedPiece = piece;
                            ...
                            switch (castle(piece, fromSquare, toSquare, Attacker, Attacked))
                            {
                                ...
                                case Castling.CASTLING_YES:
                                    ...
                                    string to = toSquare;
                                    if (to == "c1" || to == "c8")
                                        this.Game.InProgressMove.Flags.IsLongCastling = true;
                                    else
                                        this.Game.InProgressMove.Flags.IsShortCastling = true;
        ...
        private void SetEnpassantSquare(ChessPosition Attacker)
        {
            ...
            if (square >= 0)
            {
                try
                {
                    ...
                    this.Game.Flags.EnPassant = (SquareE)Enum.Parse(typeof(SquareE), enpassantSquare.ToUpper());
                }
                catch 
                {
        ...
        public delegate void updateBoard(Chess.Operation op, string FromSquare, string ToSquare);
