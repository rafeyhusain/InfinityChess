...
namespace ChessLibrary
{
  ...
  public class BitboardSquare
  {
    ...
    {
        coSquareMask = null;
        coAlphaToSquare = null;
        coSquareToAlpha = null;
        initMasks();
    }
