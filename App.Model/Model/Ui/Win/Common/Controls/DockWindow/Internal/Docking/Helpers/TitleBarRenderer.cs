...
namespace Crom.Controls.Docking
{
   ...
   internal class TitleBarRenderer
   {
      ...
      public void Draw(Font font, Graphics graphics, Color color1, Color color2)
      {
         ...
         {
             graphics.DrawString(Text, font, textBrush, ShowIcon ? iconBounds.Right : 0, iconTop + 2);             
         }
      ...
      private void DrawCaptionButtons(Rectangle captionButtonsBounds, Graphics graphics)
      {
         ...
         ////// caption buttons manual alignment - start
         // //561,577
         //if (x < 565)
         //    x = 580;
         //if (x > 565 && x < 580)
         ...
         ////// caption buttons manual alignment - end
